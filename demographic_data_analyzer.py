...
def calculate_demographic_data(print_data=True):
    ...
    country_percentages = (df[df['salary'] == '>50K'].groupby('native-country')['salary'].count() / df.groupby('native-country')['salary'].count()) * 100
    ...
    top_earners_IN = df[(df['salary'] == '>50K') & (df['native-country'] == 'India')]
    occupation_counts = top_earners_IN['occupation'].value_counts()
